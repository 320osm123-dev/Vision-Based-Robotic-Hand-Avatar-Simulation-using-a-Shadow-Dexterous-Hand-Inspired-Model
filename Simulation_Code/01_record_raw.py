...
log_file = open("fingertip_position_log.csv", "w", newline="", encoding="utf-8")
csv_writer = csv.writer(log_file)
csv_writer.writerow(make_fingertip_csv_header())

raw_log_file = open("raw_hand_landmarks.csv", "w", newline="", encoding="utf-8")
...
# 루프 1회당 mj_step 1번으로 고정하지 않고, 실제 지난 시간만큼 MuJoCo step을 누적 실행
